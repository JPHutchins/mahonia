...
@st.composite
def contexts_strategy(draw: DrawFn) -> PropertyTestCtx:
...
@st.composite
def int_consts(draw: DrawFn) -> Const[int]:
...
class TestArithmeticProperties:
	...
	@given(st.integers())
	def test_addition_identity(self, a: int) -> None:
	...
	@given(st.integers())
	def test_multiplication_identity(self, a: int) -> None:
	...
	@given(st.integers())
	def test_multiplication_zero(self, a: int) -> None:
	...
	@given(st.integers(), st.integers())
	def test_subtraction_inverse(self, a: int, b: int) -> None:
		"""(a - b) + b == a for all integers a, b"""
		ca = Const("a", a)
		cb = Const("b", b)
		expr = (ca - cb) + cb
	...
	def test_division_inverse(self, a: float) -> None:
...
class TestComparisonProperties:
	...
	@given(st.integers())
	def test_equality_reflexive(self, a: int) -> None:
		"""a == a is always True"""
		ca = Const("a", a)
		expr = ca == ca
	...
	@given(st.integers(), st.integers())
	def test_equality_symmetric(self, a: int, b: int) -> None:
		"""(a == b) == (b == a) for all a, b"""
		ca = Const("a", a)
		cb = Const("b", b)
		expr1 = ca == cb
	...
	def test_equality_transitive(self, a: int, b: int, c: int) -> None:
	...
	@given(st.integers(), st.integers())
	def test_inequality_complement(self, a: int, b: int) -> None:
	...
	@given(st.integers(), st.integers())
	def test_less_than_antisymmetric(self, a: int, b: int) -> None:
		"""If a < b, then not (b < a)"""
		ca = Const("a", a)
		cb = Const("b", b)
		expr1 = ca < cb
...
class TestLogicalProperties:
	...
	def test_and_commutative(self, ctx: PropertyTestCtx) -> None:
	...
	@given(contexts_strategy())
	def test_or_commutative(self, ctx: PropertyTestCtx) -> None:
		"""a | b == b | a for boolean expressions"""
		x = Var[int, PropertyTestCtx]("x")
		y = Var[int, PropertyTestCtx]("y")
	...
	@given(contexts_strategy())
	def test_and_associative(self, ctx: PropertyTestCtx) -> None:
	...
	@given(contexts_strategy())
	def test_or_associative(self, ctx: PropertyTestCtx) -> None:
		"""(a | b) | c == a | (b | c) for boolean expressions"""
		x = Var[int, PropertyTestCtx]("x")
		y = Var[int, PropertyTestCtx]("y")
		z = Var[int, PropertyTestCtx]("z")
	...
	@given(contexts_strategy())
	def test_double_negation(self, ctx: PropertyTestCtx) -> None:
...
class TestToleranceProperties:
	...
	def test_approximately_reflexive(self, value: float, tolerance: float) -> None:
	...
	def test_approximately_symmetric(self, value: float, tolerance: float) -> None:
	...
	def test_percent_tolerance_positive(self, value: float, percent: float) -> None:
...
class TestExpressionConsistency:
	...
	@given(contexts_strategy())
	def test_string_evaluation_consistency(self, ctx: PropertyTestCtx) -> None:
	...
	@given(contexts_strategy())
	def test_binding_consistency(self, ctx: PropertyTestCtx) -> None:
	...
	def test_const_context_independence(self, ctx: PropertyTestCtx, const_expr: Const[int]) -> None:
	...
	@given(contexts_strategy())
	def test_predicate_boolean_consistency(self, ctx: PropertyTestCtx) -> None:
...
class TestVariableProperties:
	...
	@given(contexts_strategy())
	def test_variable_context_binding(self, ctx: PropertyTestCtx) -> None:
	...
	@given(contexts_strategy())
	def test_variable_expression_composition(self, ctx: PropertyTestCtx) -> None:
...
class TestRegressionCases:
	...
	def test_floating_point_precision(self, value: float, tolerance: float) -> None:
